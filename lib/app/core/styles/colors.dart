...
class MainColors {
  ...
  static const gryColor = materialColors.Color.fromARGB(255, 155, 153, 153);
...
class LightColors {
  ...
  static const Color shadowColor = materialColors.Color(0xFFEAEAEA);
  static const Color textColor = materialColors.Color(0xFF1A2D40);
  static const Color inputColor = materialColors.Color(0xFFF6F6F6);
  static const Color disableColor = materialColors.Color(0xFFD2D2D2);
