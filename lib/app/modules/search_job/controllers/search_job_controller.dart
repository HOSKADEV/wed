...
class SearchJobController extends GetxController {
  ...
  void sendData() async {
    if (formKey.currentState!.validate()) {
      ...
      String message = ' [تطبيق دلني] : "البحث عن عمل" \n'
          'الاسم الكامل : ${nameCarController.text}\n'
          'العمر: ${oldController.text}\n'
          'المهنة او العمل المطلوب: ${jobController.text}\n'
          'الشهادة او المستوى الدراسي المطلوب: ${certificateController.text == "" ? "غير مهم" : certificateController.text}\n'
          ' نوع العمل المطلوب: ${selectedTimeJob.value?.title.toString()}\n';
